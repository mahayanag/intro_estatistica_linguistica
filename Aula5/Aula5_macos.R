...
## Uma empresa ensaca cafés afirmando que cada saco tem ***500g***. A empresa também informa que o maquinário que produz o conteúdo deve retornar esse valor com *** σ = 25g***.
...
#Assumindo um α = 0.05, é possível afirmar que a amostra recolhida indica que o maquinário está produzindo pacotes com média superior ao valor pretendido?
...
#A função t.test() realiza um teste-t considerando α = 0.05.

# O cálculo do p-valor considerando esse α dependerá da Ha especificada.
...
#Considerando α = 0.05, avalie se a propaganda surtiu o efeito desejado pelo supermercado.
