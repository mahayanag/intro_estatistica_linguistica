...
#Pessoalmente prefiro informar assim, pois mantenho minhas pastas organizadas e, daqui há meses ou anos, quando quiser rodar o código, basta rodar o comando acima que ele acha o diretório para mim, sem que eu tenha que ficar indicando manualmente.
...
ggplot(dados.scores, aes(x = scores, y = ))+
  geom_histogram(breaks=seq(0, 100, by = 1), color = "blue", alpha=0.5)
